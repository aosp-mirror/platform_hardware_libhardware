...
typedef enum {
    ...
    GRALLOC1_FUNCTION_CREATE_DESCRIPTOR = 1,
    GRALLOC1_FUNCTION_DESTROY_DESCRIPTOR = 2,
    GRALLOC1_FUNCTION_SET_CONSUMER_USAGE = 3,
    GRALLOC1_FUNCTION_SET_DIMENSIONS = 4,
    GRALLOC1_FUNCTION_SET_FORMAT = 5,
    GRALLOC1_FUNCTION_SET_PRODUCER_USAGE = 6,
    GRALLOC1_FUNCTION_GET_BACKING_STORE = 7,
    GRALLOC1_FUNCTION_GET_CONSUMER_USAGE = 8,
    GRALLOC1_FUNCTION_GET_DIMENSIONS = 9,
    GRALLOC1_FUNCTION_GET_FORMAT = 10,
    GRALLOC1_FUNCTION_GET_PRODUCER_USAGE = 11,
    GRALLOC1_FUNCTION_GET_STRIDE = 12,
    GRALLOC1_FUNCTION_ALLOCATE = 13,
    GRALLOC1_FUNCTION_RETAIN = 14,
    GRALLOC1_FUNCTION_RELEASE = 15,
    GRALLOC1_FUNCTION_GET_NUM_FLEX_PLANES = 16,
    GRALLOC1_FUNCTION_LOCK = 17,
    GRALLOC1_FUNCTION_LOCK_FLEX = 18,
    GRALLOC1_FUNCTION_UNLOCK = 19,
